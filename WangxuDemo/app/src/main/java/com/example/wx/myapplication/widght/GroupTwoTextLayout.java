package com.example.wx.myapplication.widght;
 ...
 *
 */
public class GroupTwoTextLayout  extends RelativeLayout {
    ...
    public GroupTwoTextLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
